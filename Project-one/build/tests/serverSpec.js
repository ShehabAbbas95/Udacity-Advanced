...
describe('test our main server api', () => {
    it('test welcome api', () => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = yield requestTest.get('/');
        expect(apiResponse.status).toBe(200);
    }));
    it('test our image processing api ', () => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = yield requestTest.get('/image?filename=index.jpg&width=200&height=200');
        expect(apiResponse.status).toBe(200);
    }));
    it('test our image processing api if  query data is missing ', (done) => __awaiter(void 0, void 0, void 0, function* () {
